...
coverpkg="github.com/serenite11/op-geth/..."
...
repo=$GOPATH/src/github.com/serenite11/op-geth
compile_fuzzer github.com/serenite11/op-geth/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/serenite11/op-geth/common/bitutil \
...
compile_fuzzer github.com/serenite11/op-geth/core/vm/runtime \
  FuzzVmRuntime fuzzVmRuntime\
  $repo/core/vm/runtime/runtime_fuzz_test.go

compile_fuzzer github.com/serenite11/op-geth/core/vm \
  FuzzPrecompiledContracts fuzzPrecompiledContracts\
  $repo/core/vm/contracts_fuzz_test.go,$repo/core/vm/contracts_test.go

compile_fuzzer github.com/serenite11/op-geth/core/types \
  FuzzRLP fuzzRlp \
  $repo/core/types/rlp_fuzzer_test.go

compile_fuzzer github.com/serenite11/op-geth/crypto/blake2b \
  Fuzz fuzzBlake2b \
  $repo/crypto/blake2b/blake2b_f_fuzz_test.go

compile_fuzzer github.com/serenite11/op-geth/accounts/keystore \
  FuzzPassword fuzzKeystore \
  $repo/accounts/keystore/keystore_fuzzing_test.go

pkg=$repo/trie/
compile_fuzzer github.com/serenite11/op-geth/trie \
  FuzzTrie fuzzTrie \
...
compile_fuzzer github.com/serenite11/op-geth/eth/protocols/snap \
...
compile_fuzzer github.com/serenite11/op-geth/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/serenite11/op-geth/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/serenite11/op-geth/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/serenite11/op-geth/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
  $repo/tests/fuzzers/secp256k1/secp_test.go

compile_fuzzer github.com/serenite11/op-geth/eth/protocols/eth \
